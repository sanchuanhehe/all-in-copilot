...
describe("Message Content Extraction", () => {
  ...
  function extractUserContent(message: { kind?: string; text?: string; value?: string; parts?: unknown[]; data?: { type: string; data: number[] } }): string | null {
